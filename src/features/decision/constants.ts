...
export const DEFAULT_SCENARIOS = [
  "Post-merger integration with cultural clash risk", "Rapid scaling in a new geographic market",
  "Digital transformation in a legacy enterprise", "Crisis turnaround with limited runway",
  "Greenfield product launch in competitive market",
];
export const DECISION_MODES = [
  { value: "best_fit", label: "Best Fit" }, { value: "lowest_risk", label: "Risk-Adjusted Choice" }, { value: "best_outcome", label: "Best Outcome" },
] as const;
...
export const INITIAL_STAGES: PipelineStage[] = [
  { id: "input", label: "Input Received", status: "pending" }, { id: "context", label: "Context Analysis", status: "pending" },
  { id: "scoring", label: "Candidate Scoring", status: "pending" }, { id: "confidence_review", label: "Confidence & Evidence Review", status: "pending" },
  { id: "outcome", label: "Outcome Modeling", status: "pending" }, { id: "pairing", label: "Pair Simulation", status: "pending" },
  { id: "decision", label: "Decision Engine", status: "pending" }, { id: "complete", label: "Completed", status: "pending" },
];
