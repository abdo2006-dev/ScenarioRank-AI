...
import type { CandidateInput, PipelineResponse, PipelineStage } from "../contracts";
import { useDecisionEvaluation } from "../hooks/useDecisionEvaluation";

type CriterionScore = PipelineResponse["candidate_evaluations"][number]["criteria_scores"][string];
